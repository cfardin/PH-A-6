  ...
  return (
    <div className="w-full md:w-10/12 m-auto mb-30">
        ...
        <div className="space-y-2.5 mb-10">
            <h3 className="text-5xl font-extrabold text-center">Get Started in 3 Steps</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {steps.map((s, i) => (
          <div
            key={i}
            className="flex flex-col items-center text-center relative bg-white rounded-2xl p-8  shadow-sm"
          >
